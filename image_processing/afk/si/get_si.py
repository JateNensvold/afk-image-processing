...
# def get_si(roster_image: np.ndarray, debug_raw: bool = None,
...
# def detect_features(pseudo_name: str, image_info: processing.HERO_INFO):
#     """
...
#     test_img = test_img[..., ::-1]
#     results = GV.FI_SI_STAR_MODEL([test_img], size=416)  # pylint: disable=not-callable
...
#         raw_border_results = GV.ASCENSION_BORDER_MODEL(
#             test_img)
