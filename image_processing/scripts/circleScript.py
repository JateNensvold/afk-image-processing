...
while guess_accumulator_array_threshold > 1 and breakout is False:
    # start out with smallest resolution possible, to find the most precise
    #   circle, then creep bigger if none found
    guess_dp = 1.0
    ...
    while guess_dp < 9 and breakout is False:
        ...
        while True:
            ...
            # HoughCircles algorithm isn't strong enough to stand on its own
            #   if you don't
            # know EXACTLY what radius the circle in the image is, (accurate
            #   to within 3 pixels)
            # If you don't know radius, you need lots of guess and check and
            #   lots of post-processing
            # verification.  Luckily HoughCircles is pretty quick so we can
            #   brute force.
